...
const cardItemVariants = {
  ...
  visible: { y: 0, opacity: 1, scale: 1, transition: { type: "spring", stiffness: 50, damping: 15 } }
};
    ...
    <>
      <section id='pricing' className="relative w-full py-20 overflow-x-hidden min-h-screen flex flex-col justify-center">
        ...
        >
          ...
          {/* Tabs */}
          <motion.div variants={fadeUpVariants} className="flex justify-start md:justify-center overflow-x-auto pb-8 mb-4 scrollbar-hide px-4">
          ...
          <div className="relative group/carousel">
            ...
            <div
              ...
              className={`flex gap-6 overflow-x-auto pb-8 snap-x snap-mandatory scrollbar-hide px-4 ${isScrollableMode ? 'justify-start' : 'md:justify-center'}`}
            >
                ...
                >
                  {activeCategory.plans.map((plan, index) => (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="flex-none w-[85%] sm:w-[300px] md:w-[350px] snap-center flex flex-col p-6 sm:p-8 rounded-2xl bg-neutral-900/60 border border-white/10 backdrop-blur-md hover:border-emerald-500/50 transition-colors"
                    >

                      <div className="mb-6">
                        <h3 className="text-lg font-mono text-emerald-400 uppercase tracking-wider mb-2">{plan.name}</h3>
      ...
      {/* Bottom puzzle row – visible on all screens */}
